execute as @s[scores={chakra=350..}] ~~~ execute as @s[scores={tp=8000..},tag=!s2_susanoo,tag=ms_obito] ~~~ give @s porkyn:s3_obito
execute as @s[scores={chakra=350..}] ~~~ execute as @s[scores={tp=8000..},tag=!s2_susanoo,tag=ms_obito] ~~~ tag @s add ss2_susanoo
...
execute as @s[tag=ss2_susanoo,tag=ms_obito,tag=!s2_susanoo] ~~~ tellraw @s {"rawtext":[{"text":"§lSeu Susano`o evoluiu!"}]}
execute as @s[tag=ss2_susanoo,tag=ms_obito,tag=!s2_susanoo] ~~~ scoreboard players remove @s tp 8000
execute as @s[tag=ss2_susanoo,tag=ms_obito,tag=!s2_susanoo] ~~~ tag @s add s2_susanoo
