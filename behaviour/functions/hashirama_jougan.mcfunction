execute as @s[scores={chakra=500..}] ~~~ function hair_kakashi

execute as @s[scores={chakra=500..}] ~~~ playsound byakugan @a[r=5]
...
execute as @s[scores={chakra=..499}] ~~~ playsound note.bass
