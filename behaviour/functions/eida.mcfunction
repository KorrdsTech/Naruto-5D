execute @s[scores={chakralimite=1999..1000001}] ~~~ clear @s porkyn:eida
execute @s[scores={chakralimite=1999..1000001}] ~~~ replaceitem entity @s slot.armor.head 1 porkyn:eida
...
execute @s[scores={chakralimite=1999..1000001}] ~~~ effect @s strength 9999 8 true
...
execute @s[scores={chakralimite=1999..1000001}] ~~~ effect @s health_boost 9999 78 true
