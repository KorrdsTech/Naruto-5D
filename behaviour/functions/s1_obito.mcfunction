execute @s[scores={chakra=250..}] ~~~ execute @s[scores={tp=6000..},tag=!s1_susanoo,tag=ms_obito] ~~~ give @s porkyn:s2_obito
execute @s[scores={chakra=250..}] ~~~ execute @s[scores={tp=6000..},tag=!s1_susanoo,tag=ms_obito] ~~~ tag @s add ss1_susanoo
...
execute @s[tag=ss1_susanoo,tag=ms_obito,tag=!s1_susanoo] ~~~ tellraw @s {"rawtext":[{"text":"§lSeu Susano`o evoluiu!"}]}
execute @s[tag=ss1_susanoo,tag=ms_obito,tag=!s1_susanoo] ~~~ scoreboard players remove @s tp 6000
execute @s[tag=ss1_susanoo,tag=ms_obito,tag=!s1_susanoo] ~~~ tag @s add s1_susanoo
