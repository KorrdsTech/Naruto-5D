...
execute @s[scores={chakra=200..}] ~~~ tag @s remove corvos
execute @s[scores={chakra=200..}] ~~~ tag @s remove hiraishin1
execute @s[scores={chakra=200..}] ~~~ tag @s add kamui


execute @s[scores={chakra=200..}] ~~~ clear @p porkyn:kamuimenu
execute @s[scores={chakra=200..}] ~~~ give @p porkyn:kamuimenu 1 0 {"item_lock":{"mode":"lock_in_inventory"},"keep_on_death":{}}

execute @s[scores={chakra=200..}] ~~~ clear @p porkyn:kamui_1
execute @s[scores={chakra=200..}] ~~~ clear @p porkyn:kamui_2
execute @s[scores={chakra=200..}] ~~~ clear @p porkyn:kamui_3
execute @s[scores={chakra=200..}] ~~~ clear @p porkyn:kamui_4
execute @s[scores={chakra=200..}] ~~~ clear @p porkyn:kamui_5
execute @s[scores={chakra=200..}] ~~~ clear @p porkyn:kamui_6
execute @s[scores={chakra=200..}] ~~~ give @p porkyn:kamui_1 1 0 {"item_lock":{"mode":"lock_in_inventory"},"keep_on_death":{}}
