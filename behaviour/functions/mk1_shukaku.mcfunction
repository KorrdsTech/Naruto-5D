...
execute as @s[scores={tp=6000..},tag=!mk1_shukaku] ~~~ give @s porkyn:mk3_shukaku
execute as @s[scores={tp=6000..},tag=!mk1_shukaku] ~~~ tag @s add mk1_shukakua
...
execute as @s[tag=mk1_shukakua,tag=!mk1_shukaku] ~~~ tellraw @s {"rawtext":[{"text":"§l>Você aprendeu o Modo Rikudou [shukaku]!<"}]}
execute as @s[tag=mk1_shukakua,tag=!mk1_shukaku] ~~~ scoreboard players remove @s tp 6000
execute as @s[tag=mk1_shukakua,tag=!mk1_shukaku] ~~~ tag @s add mk1_shukaku
