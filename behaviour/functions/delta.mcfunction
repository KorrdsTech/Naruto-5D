execute @s[scores={chakra=100..1000001}] ~~~ clear @s porkyn:delta
execute @s[scores={chakra=100..1000001}] ~~~ replaceitem entity @s slot.armor.head 1 porkyn:delta
...
execute @s[scores={chakra=100..1000001}] ~~~ effect @s speed 9999 4 true
execute @s[scores={chakra=100..1000001}] ~~~ effect @s night_vision 9999 2 true
execute @s[scores={chakra=100..1000001}] ~~~ effect @s strength 9999 5 true
...
execute @s[scores={chakra=100..1000001}] ~~~ effect @s health_boost 9999 65 true
