...
execute @s[scores={chakra=40..},tag=vento] ^^^10 /execute @e[r=10] ~~~ effect @e[r=5] instant_damage 1 6 true
execute @s[scores={chakra=40..},tag=vento] ^^2^7 /execute @e[r=10] ~~~ effect @e[r=5] instant_damage 1 6 true
execute @s[scores={chakra=40..},tag=vento] ^^^4 /execute @e[r=10] ~~~ effect @e[r=5] instant_damage 1 6 true
execute @s[scores={chakra=40..},tag=vento] ^^2^1 /execute @e[r=10] ~~~ effect @e[r=5] instant_damage 1 6 true
