...
execute as @s[scores={chakra=250..},tag=papel] ~~~ clear @p porkyn:caixao_papel
execute as @s[scores={chakra=250..},tag=papel] ~~~ give @p porkyn:caixao_papel 1 0 {"item_lock":{"mode":"lock_in_inventory"},"keep_on_death":{}}

execute as @s[scores={chakra=250..},tag=papel] ~~~ clear @p porkyn:defesa_papel
execute as @s[scores={chakra=250..},tag=papel] ~~~ give @p porkyn:defesa_papel 1 0 {"item_lock":{"mode":"lock_in_inventory"},"keep_on_death":{}}
