execute @s[scores={chakra=350..}] ~~~ execute @s[scores={tp=8000..},tag=!s2_susanoo,tag=ms_madara] ~~~ give @s porkyn:s3_madara
execute @s[scores={chakra=350..}] ~~~ execute @s[scores={tp=8000..},tag=!s2_susanoo,tag=ms_madara] ~~~ tag @s add ss2_susanoo
...
execute @s[tag=ss2_susanoo,tag=ms_madara,tag=!s2_susanoo] ~~~ tellraw @s {"rawtext":[{"text":"§lSeu Susano`o evoluiu!"}]}
execute @s[tag=ss2_susanoo,tag=ms_madara,tag=!s2_susanoo] ~~~ scoreboard players remove @s tp 8000
execute @s[tag=ss2_susanoo,tag=ms_madara,tag=!s2_susanoo] ~~~ tag @s add s2_susanoo
