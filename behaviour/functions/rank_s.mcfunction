execute as @s[tag=uchiha] ~~~ clear @p porkyn:rs_sasuke
execute as @s[tag=uchiha] ~~~ clear @p porkyn:rs_itachi
execute as @s[tag=uchiha] ~~~ clear @p porkyn:rs_shisui
execute as @s[tag=uchiha] ~~~ clear @p porkyn:rs_madara
execute as @s[tag=uchiha] ~~~ clear @p porkyn:rs_obito
execute as @s[tag=uchiha] ~~~ clear @p porkyn:r_sasuke
execute as @s[tag=uchiha] ~~~ clear @p porkyn:r_itachi
execute as @s[tag=uchiha] ~~~ clear @p porkyn:r_shisui
execute as @s[tag=uchiha] ~~~ clear @p porkyn:r_madara
execute as @s[tag=uchiha] ~~~ clear @p porkyn:r_obito
...
execute as @s[tag=uchiha,scores={chakra=100..},tag=msd_sasuke] ~~~ clear @p porkyn:amaterasu_i
execute as @s[tag=uchiha,scores={chakra=100..},tag=msd_sasuke] ~~~ give @p porkyn:amaterasu_i 1 0 {"item_lock":{"mode":"lock_in_inventory"},"keep_on_death":{}}

execute as @s[tag=uchiha,scores={chakra=100..},tag=msd_itachi] ~~~ clear @p porkyn:amaterasu_i
execute as @s[tag=uchiha,scores={chakra=100..},tag=msd_itachi] ~~~ give @p porkyn:amaterasu_i 1 0 {"item_lock":{"mode":"lock_in_inventory"},"keep_on_death":{}}

execute as @s[tag=uchiha,scores={chakra=100..},tag=msd_itachi] ~~~ clear @p porkyn:tsukiyomi
execute as @s[tag=uchiha,scores={chakra=100..},tag=msd_itachi] ~~~ give @p porkyn:tsukiyomi 1 0 {"item_lock":{"mode":"lock_in_inventory"},"keep_on_death":{}}

execute as @s[scores={chakra=100..},tag=uchiha,tag=msd_obito] ~~~ clear @p porkyn:kamuimenu
execute as @s[tag=uchiha,scores={chakra=100..},tag=msd_obito] ~~~ clear @p porkyn:kamui_1
execute as @s[tag=uchiha,scores={chakra=100..},tag=msd_obito] ~~~ clear @p porkyn:kamui_2
execute as @s[tag=uchiha,scores={chakra=100..},tag=msd_obito] ~~~ clear @p porkyn:kamui_3
execute as @s[tag=uchiha,scores={chakra=100..},tag=msd_obito] ~~~ clear @p porkyn:kamui_4
execute as @s[tag=uchiha,scores={chakra=100..},tag=msd_obito] ~~~ clear @p porkyn:kamui_5
execute as @s[tag=uchiha,scores={chakra=100..},tag=msd_obito] ~~~ clear @p porkyn:kamui_6
execute as @s[tag=uchiha,scores={chakra=100..},tag=msd_obito] ~~~ give @p porkyn:kamui_1 1 0 {"item_lock":{"mode":"lock_in_inventory"},"keep_on_death":{}}
execute as @s[tag=uchiha,scores={chakra=100..},tag=msd_obito] ~~~ give @p porkyn:kamuimenu 1 0 {"item_lock":{"mode":"lock_in_inventory"},"keep_on_death":{}}

execute as @s[tag=uchiha,scores={chakra=100..}] ~~~ clear @p porkyn:shinra_tensei
execute as @s[tag=uchiha,scores={chakra=100..}] ~~~ give @p porkyn:shinra_tensei 1 0 {"item_lock":{"mode":"lock_in_inventory"},"keep_on_death":{}}

execute as @s[tag=uchiha,scores={chakra=100..}] ~~~ clear @p porkyn:banshou_tenin
execute as @s[tag=uchiha,scores={chakra=100..}] ~~~ give @p porkyn:banshou_tenin 1 0 {"item_lock":{"mode":"lock_in_inventory"},"keep_on_death":{}}

execute as @s[tag=uchiha,scores={chakra=100..}] ~~~ clear @p porkyn:chibaku
execute as @s[tag=uchiha,scores={chakra=100..}] ~~~ give @p porkyn:chibaku 1 0 {"item_lock":{"mode":"lock_in_inventory"},"keep_on_death":{}}

execute as @s[tag=uchiha,scores={chakra=100..},tag=msd_sasuke] ~~~ tag @p add rinnegantp
execute as @s[tag=uchiha,scores={chakra=100..},tag=msd_sasuke] ~~~ clear @p porkyn:rinneganmenu
execute as @s[tag=uchiha,scores={chakra=100..},tag=msd_sasuke] ~~~ clear @p porkyn:rinnegan_6
execute as @s[tag=uchiha,scores={chakra=100..},tag=msd_sasuke] ~~~ clear @p porkyn:rinnegan_5
execute as @s[tag=uchiha,scores={chakra=100..},tag=msd_sasuke] ~~~ clear @p porkyn:rinnegan_4
execute as @s[tag=uchiha,scores={chakra=100..},tag=msd_sasuke] ~~~ clear @p porkyn:rinnegan_3
execute as @s[tag=uchiha,scores={chakra=100..},tag=msd_sasuke] ~~~ clear @p porkyn:rinnegan_2
execute as @s[tag=uchiha,scores={chakra=100..},tag=msd_sasuke] ~~~ clear @p porkyn:rinnegan_1
execute as @s[tag=uchiha,scores={chakra=100..},tag=msd_sasuke] ~~~ clear @p porkyn:rinnegan_1
execute as @s[tag=uchiha,scores={chakra=100..},tag=msd_sasuke] ~~~ give @p porkyn:rinnegan_1 1 0 {"item_lock":{"mode":"lock_in_inventory"},"keep_on_death":{}}
execute as @s[tag=uchiha,scores={chakra=100..},tag=msd_sasuke] ~~~ give @p porkyn:rinneganmenu 1 0 {"item_lock":{"mode":"lock_in_inventory"},"keep_on_death":{}}
...
execute as @s[tag=uchiha,scores={chakra=300..},tag=msd_itachi] ~~~  replaceitem entity @s slot.armor.chest 1 porkyn:s4_itachi 1 0 {"item_lock":{"mode":"lock_in_inventory"},"keep_on_death":{}}
...
effect @s[tag=uchiha,scores={chakra=250..}] slowness 300 0 true
effect @s[tag=uchiha,scores={chakra=250..}] jump_boost 300 4 true
execute as @s[tag=uchiha,scores={chakra=300..},tag=msd_sasuke] ~~~  replaceitem entity @s slot.armor.chest 1 porkyn:s4_sasuke 1 0 {"item_lock":{"mode":"lock_in_inventory"},"keep_on_death":{}}
effect @s[tag=uchiha,scores={chakra=300..}] haste 500 20 true
effect @s[tag=uchiha,scores={chakra=300..}] absorption 500 255 true
effect @s[tag=uchiha,scores={chakra=300..}] slowness 0 0 true
effect @s[tag=uchiha,scores={chakra=300..}] jump_boost 500 6 true
...
effect @s[tag=uchiha,scores={chakra=250..}] slowness 300 0 true
effect @s[tag=uchiha,scores={chakra=250..}] jump_boost 300 4 true
execute as @s[tag=uchiha,scores={chakra=300..},tag=msd_madara] ~~~  replaceitem entity @s slot.armor.chest 1 porkyn:s4_madara 1 0 {"item_lock":{"mode":"lock_in_inventory"},"keep_on_death":{}}
effect @s[tag=uchiha,scores={chakra=300..}] haste 500 20 true
effect @s[tag=uchiha,scores={chakra=300..}] absorption 500 255 true
effect @s[tag=uchiha,scores={chakra=300..}] slowness 0 0 true
effect @s[tag=uchiha,scores={chakra=300..}] jump_boost 500 6 true
...
effect @s[tag=uchiha,scores={chakra=250..}] slowness 300 0 true
effect @s[tag=uchiha,scores={chakra=250..}] jump_boost 300 4 true
execute as @s[tag=uchiha,scores={chakra=300..},tag=msd_obito] ~~~  replaceitem entity @s slot.armor.chest 1 porkyn:s4_obito 1 0 {"item_lock":{"mode":"lock_in_inventory"},"keep_on_death":{}}
effect @s[tag=uchiha,scores={chakra=300..}] haste 500 20 true
effect @s[tag=uchiha,scores={chakra=300..}] absorption 500 255 true
effect @s[tag=uchiha,scores={chakra=300..}] slowness 0 0 true
effect @s[tag=uchiha,scores={chakra=300..}] jump_boost 500 6 true
...
effect @s[tag=uchiha,scores={chakra=250..}] slowness 300 0 true
effect @s[tag=uchiha,scores={chakra=250..}] jump_boost 300 4 true
execute as @s[tag=uchiha,scores={chakra=300..},tag=msd_shisui] ~~~  replaceitem entity @s slot.armor.chest 1 porkyn:s4_shisui 1 0 {"item_lock":{"mode":"lock_in_inventory"},"keep_on_death":{}}
effect @s[tag=uchiha,scores={chakra=300..}] haste 500 20 true
effect @s[tag=uchiha,scores={chakra=300..}] absorption 500 255 true
effect @s[tag=uchiha,scores={chakra=300..}] slowness 0 0 true
effect @s[tag=uchiha,scores={chakra=300..}] jump_boost 500 6 true
...
hyuuga
execute as @s[tag=hyuuga,scores={chakra=100..}] ~~~ clear @s porkyn:tenseigan
...
uzumaki
execute as @s[tag=uzumaki,scores={chakra=100..}] ~~~ clear @s porkyn:correntes_adamantinas_5
...
chinoike
execute as @s[tag=chinoike,scores={chakra=100..}] ~~~ clear @s porkyn:ketsuryugan_5
...
kazekage
execute as @s[tag=kazekage,scores={chakra=100..}] ~~~ clear @s porkyn:cabaca_areia_5
...
senju
execute as @s[tag=senju,scores={chakra=100..}] ~~~ clear @s porkyn:senju_5
...
execute as @s[tag=senju,scores={chakra=1800..}] ~~~  replaceitem entity @s slot.armor.chest 1 porkyn:mil_mao 1 0 {"item_lock":{"mode":"lock_in_inventory"},"keep_on_death":{}}
