execute @s[scores={chakra=100..1000001}] ~~~ clear @s porkyn:deepa
execute @s[scores={chakra=100..1000001}] ~~~ replaceitem entity @s slot.armor.head 1 porkyn:deepa
...
execute @s[scores={chakra=100..1000001}] ~~~ effect @s speed 9999 2 true
execute @s[scores={chakra=100..1000001}] ~~~ effect @s night_vision 9999 2 true
execute @s[scores={chakra=100..1000001}] ~~~ effect @s strength 9999 2 true
execute @s[scores={chakra=100..1000001}] ~~~ effect @s haste 9999 1 true
execute @s[scores={chakra=100..1000001}] ~~~ effect @s instant_health 3 255 true
execute @s[scores={chakra=100..1000001}] ~~~ effect @s resistance 9999 1 true
execute @s[scores={chakra=100..1000001}] ~~~ effect @s health_boost 9999 25 true
