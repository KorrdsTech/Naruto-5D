execute @s[scores={chakra=100..1000001}] ~~~ clear @s porkyn:daemon
execute @s[scores={chakra=100..1000001}] ~~~ replaceitem entity @s slot.armor.head 1 porkyn:daemon
...
execute @s[scores={chakra=100..1000001}] ~~~ effect @s strength 9999 6 true
...
execute @s[scores={chakra=100..1000001}] ~~~ effect @s health_boost 9999 67 true
