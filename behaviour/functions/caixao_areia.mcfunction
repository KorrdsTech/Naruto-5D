...
execute as @s[tag=areia,scores={chakra=40..}] ~~~ playanimation @s animation.caixao_areia porkyntop 10
...
execute as @s[tag=areia,scores={chakra=40..}] ~~~ execute as @e[r=10,tag=!areia] ~~~ fill ~-1~-1~-1~1~2~1 sand 

execute as @s[tag=areia,scores={chakra=40..}] ~~~ execute as @e[r=10,tag=!areia] ~~~ fill ~~~~~1~ sandstone
