...
execute @s[scores={chakra=40..},tag=raio] ^^^10 execute @e[r=10] ~~~ effect @e[r=5] instant_damage 1 5 true
execute @s[scores={chakra=40..},tag=raio] ^^2^7 execute @e[r=10] ~~~ effect @e[r=5] instant_damage 1 5 true
execute @s[scores={chakra=40..},tag=raio] ^^^4 execute @e[r=10] ~~~ effect @e[r=5] instant_damage 1 5 true
execute @s[scores={chakra=40..},tag=raio] ^^2^1 execute @e[r=10] ~~~ effect @e[r=5] instant_damage 1 5 true

effect @s instant_damage 0 0 true


execute @s[scores={tp=6400..}] ~~~ replaceitem entity @s slot.weapon.mainhand 1 porkyn:raiton_dan_ibuki_s 1 0 {"item_lock":{"mode":"lock_in_inventory"},"keep_on_death":{}}
