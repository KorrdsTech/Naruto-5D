execute as @s[scores={chakra=250..}] ~~~ execute as @s[scores={tp=6000..},tag=!s1_susanoo,tag=ms_madara] ~~~ give @s porkyn:s2_madara
execute as @s[scores={chakra=250..}] ~~~ execute as @s[scores={tp=6000..},tag=!s1_susanoo,tag=ms_madara] ~~~ tag @s add ss1_susanoo
...
execute as @s[tag=ss1_susanoo,tag=ms_madara,tag=!s1_susanoo] ~~~ tellraw @s {"rawtext":[{"text":"§lSeu Susano`o evoluiu!"}]}
execute as @s[tag=ss1_susanoo,tag=ms_madara,tag=!s1_susanoo] ~~~ scoreboard players remove @s tp 6000
execute as @s[tag=ss1_susanoo,tag=ms_madara,tag=!s1_susanoo] ~~~ tag @s add s1_susanoo
