execute as @s[scores={chakra=800..}] ~~~ playsound susanoo @a[r=5]									
...
execute as @s[scores={chakra=200..},tag=uchiha] ~~~ clear @p porkyn:katana_itachi
execute as @s[scores={chakra=200..},tag=uchiha] ~~~ give @p porkyn:katana_itachi 1 0 {"item_lock":{"mode":"lock_in_inventory"},"keep_on_death":{}}
...
execute as @s[scores={chakra=..799}] ~~~ playsound note.bass
