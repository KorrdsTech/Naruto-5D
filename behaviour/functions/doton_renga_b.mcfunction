...
execute @e[tag=terra,scores={chakra=40..}] ~~~ fill ^-6 ^-3 ^3 ^6 ^7 ^3 stone 1

execute @s[scores={tp=1600..}] ~~~ replaceitem entity @s slot.weapon.mainhand 1 porkyn:doton_renga_a 1 0 {"item_lock":{"mode":"lock_in_inventory"},"keep_on_death":{}}
