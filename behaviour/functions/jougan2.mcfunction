...
execute as @s[scores={chakra=300..}] ~~~ execute as @s[scores={tp=8000..}] ~~~ replaceitem entity  @s slot.armor.head 1 porkyn:hashirama_jougan
execute as @s[scores={chakra=300..}] ~~~ execute as @s[scores={tp=8000..}] ~~~ scoreboard players remove @s tp 800
