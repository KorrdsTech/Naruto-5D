execute @s[scores={chakralimite=1999..1000001}] ~~~ clear @s porkyn:kashin
execute @s[scores={chakralimite=1999..1000001}] ~~~ replaceitem entity @s slot.armor.head 1 porkyn:kashin
...
execute @s[scores={chakralimite=1999..1000001}] ~~~ effect @s health_boost 9999 48 true
