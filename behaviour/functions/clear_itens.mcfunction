...
<scoreboard>
execute as @a ~~~ titleraw @s actionbar {"rawtext":[{"text":"§lChakra: §r§l"},{"score":{"name":"@s","objective":"chakra"}},{"text":""},{"text":"%   §r§k§7||§r"},{"text":"§l§aMoney: §r§l"},{"score":{"name":"@s","objective":"money"}},{"text":"§l§esubs: §r§l"},{"score":{"name":"@s","objective":"subs"}},{"text":""},{"text":"\n§r"},{"text":"§l§4Chakra: §r§l"},{"score":{"name":"@s","objective":"chakra_kurama"}},{"text":"% §r§k§7§r§l§6Tp: §r§l"},{"score":{"name":"@s","objective":"xp"}}]} 

<KIT INICIAL>
execute as @s[tag=!ccc] ~~~ scoreboard players set @s health 10
execute as @s[tag=!ccc] ~~~ scoreboard players set @s chakra 700
...
<SHARINGAN>
execute as @s[tag=uchiha,tag=!uchiha_inicio,scores={xp=300..}] ~~~ playsound sharingan @a[x=~,y=~,z=~,r=5]
...
<BYAKUGAN>
execute as @s[tag=hyuuga,tag=!hyuuga_inicio,scores={xp=300..}] ~~~ playsound byakugan @a[x=~,y=~,z=~,r=5]
...
<ketsuryugan>
execute as @s[tag=chinoike,tag=!chinoike_inicio,scores={xp=200..}] ~~~ playsound ketsuryugan @a[x=~,y=~,z=~,r=5]
...
<CHAKRA>
execute as @s[tag=senju] ~~~ execute as @s[scores={chakra=5000..}] ~~~ scoreboard players set @s chakra 10000
execute as @s[tag=uzumaki] ~~~ execute as @s[scores={chakra=2500..}] ~~~ scoreboard players set @s chakra 2500
execute as @s[tag=uchiha] ~~~ execute as @s[scores={chakra=1000..}] ~~~ scoreboard players set @s chakra 1000
execute as @s[tag=hyuuga] ~~~ execute as @s[scores={chakra=1000..}] ~~~ scoreboard players set @s chakra 1000
execute as @s[tag=chinoike] ~~~ execute as @s[scores={chakra=1100..}] ~~~ scoreboard players set @s chakra 1100
...
execute as @s[scores={subs=4..}] ~~~ scoreboard players set @s subs 4
...
execute as @s[scores={chakra=500..},tag=kurama] ~~~ scoreboard players remove @s chakra_kurama 1
execute as @s[scores={chakra_kurama=1000..},tag=kurama] ~~~ scoreboard players set @s chakra_kurama 1000
execute as @s[scores={chakra_kurama=..0},tag=kurama] ~~~ scoreboard players set @s chakra_kurama 0
...
execute as @s[scores={xp=100..},tag=fogo,tag=!jutsu1] ~~~ give @s porkyn:bola_fogo 1 0 {"item_lock":{"mode":"lock_in_inventory"},"keep_on_death":{}}
execute as @s[scores={xp=100..},tag=fogo,tag=!jutsu1] ~~~ tellraw @s {"rawtext":[{"text":">Você aprendeu o §lKaton:goukakyuu no jutsu [Rank:D]!<"}]}
execute as @s[scores={xp=100..},tag=fogo,tag=!jutsu1] ~~~ tag @s add jutsu1

execute as @s[scores={xp=100..},tag=agua,tag=!jutsu1] ~~~ give @s porkyn:estilo_agua_1 1 0 {"item_lock":{"mode":"lock_in_inventory"},"keep_on_death":{}}
execute as @s[scores={xp=100..},tag=agua,tag=!jutsu1] ~~~ tellraw @s {"rawtext":[{"text":">Você aprendeu o §lBola de água!<"}]}
execute as @s[scores={xp=100..},tag=agua,tag=!jutsu1] ~~~ tag @s add jutsu1

execute as @s[scores={xp=100..},tag=raio,tag=!jutsu1] ~~~ give @s porkyn:estilo_raio_1 1 0 {"item_lock":{"mode":"lock_in_inventory"},"keep_on_death":{}}
execute as @s[scores={xp=100..},tag=raio,tag=!jutsu1] ~~~ tellraw @s {"rawtext":[{"text":">Você aprendeu o §lRaiton: Odori Rakurai no Jutsu [Rank:D]!<"}]}
execute as @s[scores={xp=100..},tag=raio,tag=!jutsu1] ~~~ tag @s add jutsu1

execute as @s[scores={xp=100..},tag=vento,tag=!jutsu1] ~~~ give @s porkyn:estilo_vento_1 1 0 {"item_lock":{"mode":"lock_in_inventory"},"keep_on_death":{}}
execute as @s[scores={xp=100..},tag=vento,tag=!jutsu1] ~~~ tellraw @s {"rawtext":[{"text":">Você aprendeu o §llFuuton: Kamaitachi no Jutsu [Rank:D]<"}]}
execute as @s[scores={xp=100..},tag=vento,tag=!jutsu1] ~~~ tag @s add jutsu1

execute as @s[scores={xp=100..},tag=terra,tag=!jutsu1] ~~~ give @s porkyn:estilo_terra_1 1 0 {"item_lock":{"mode":"lock_in_inventory"},"keep_on_death":{}}
execute as @s[scores={xp=100..},tag=terra,tag=!jutsu1] ~~~ tellraw @s {"rawtext":[{"text":">Você aprendeu o §lDoton: Renga no Jutsu [Rank:D]!<"}]}
execute as @s[scores={xp=100..},tag=terra,tag=!jutsu1] ~~~ tag @s add jutsu1