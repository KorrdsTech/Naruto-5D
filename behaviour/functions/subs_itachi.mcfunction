...
execute @s[scores={subs=1..}] ~~~ summon porkyn:corvo ~~-2~
execute @s[scores={subs=1..}] ~~~ summon porkyn:corvo ~~-1~
execute @p[scores={subs=1..}] ~~~ summon porkyn:corvo ~~-2~
execute @s[scores={subs=1..}] ~~~ summon porkyn:corvo ~~-1~
execute @s[scores={subs=1..}] ~~~ summon porkyn:corvo ~~-2~
execute @p[scores={subs=1..}] ~~~ summon porkyn:corvo ~~-1~
execute @s[scores={subs=1..}] ~~~ summon porkyn:corvo ~~-2~
