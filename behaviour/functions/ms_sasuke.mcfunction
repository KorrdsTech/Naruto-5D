...
susanoo
execute as @s[tag=!s1_sasuke,tag=ms_sasuke,scores={chakra=100..}] ~~~ execute as @s[scores={tp=12800..}] ~~~ replaceitem entity  @s slot.armor.chest 1 porkyn:s1_sasuke
execute as @s[tag=!s1_sasuke,tag=ms_sasuke,scores={chakra=100..}] ~~~ execute as @s[scores={tp=12800..}] ~~~ tag @s add despertar_s
execute as @s[tag=!s1_sasuke,tag=ms_sasuke,scores={chakra=100..}] ~~~ execute as @s[scores={tp=12800..}] ~~~ scoreboard players remove @s tp 12800
execute as @s[tag=despertar_s,tag=ms_sasuke,scores={chakra=100..}] ~~~ tag @s add s1_sasuke
execute as @s[tag=despertar_s,tag=ms_sasuke,scores={chakra=100..}] ~~~ tag @s remove despertar_s
rinnegan
execute as @s[tag=celula_hashirama,scores={chakra=100..}] ~~~ execute as @s[scores={tp=12800..}] ~~~ replaceitem entity  @s slot.armor.head 1 porkyn:r_sasuke
execute as @s[tag=celula_hashirama,scores={chakra=100..}] ~~~ execute as @s[scores={tp=12800..}] ~~~ scoreboard players remove @s tp 12800				
rinnegan_supremo
execute as @s[tag=rinnegan_supremo,scores={chakra=100..}] ~~~ execute as @s[scores={tp=12800..}] ~~~ replaceitem entity  @s slot.armor.head 1 porkyn:rs_sasuke
execute as @s[tag=rinnegan_supremo,scores={chakra=100..}] ~~~ execute as @s[scores={tp=12800..}] ~~~ scoreboard players remove @s tp 12800
execute as @s[tag=rinnegan_supremo,scores={chakra=100..}] ~~~ execute as @s[scores={tp=12800..}] ~~~ give @p porkyn:help_amenotejiraka 1 0 {"item_lock":{"mode":"lock_in_inventory"},"keep_on_death":{}}
